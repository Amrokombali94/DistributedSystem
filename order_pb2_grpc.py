...
class OrderServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetUserOrders = channel.unary_unary(
                ...
                request_serializer=order__pb2.UserOrdersRequest.SerializeToString,
                response_deserializer=order__pb2.UserOrdersResponse.FromString,
                _registered_method=True)
...
def add_OrderServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetUserOrders': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=order__pb2.UserOrdersRequest.FromString,
                    response_serializer=order__pb2.UserOrdersResponse.SerializeToString,
            ),
...
class OrderService(object):
    ...
    def GetUserOrders(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/order.OrderService/GetUserOrders',
            order__pb2.UserOrdersRequest.SerializeToString,
            order__pb2.UserOrdersResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
